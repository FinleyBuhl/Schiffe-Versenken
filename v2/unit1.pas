...
var
  ...
  x, health: uint8;
  timestamp: uint64;
  active_player, horizontal, hit: boolean;

const
  DarkGrey: tcolor = $404040;
...
begin
  if key = 'q' then
    ...
    exit;
  if stringgrid1.GridLineColor = clmoneygreen then
    stringgrid1.GridLineColor:= DarkGrey
  else
    stringgrid1.GridLineColor:= clmoneygreen;
  //stringgrid1.repaint;
end;
